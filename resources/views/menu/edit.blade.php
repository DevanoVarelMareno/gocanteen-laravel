...
<head>
    ...
    <title>Edit Menu — Go.Canteen</title>
            ...
            <form action="/menu/{{ $menu->id }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="emoji" value="{{ old('emoji', $menu->emoji) }}"
                               class="w-full border border-gray-300 rounded-xl px-4 py-2 text-sm focus:border-purple-500 focus:outline-none"/>
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Deskripsi</label>
                        <textarea name="deskripsi" rows="2"
                                  class="w-full border border-gray-300 rounded-xl px-4 py-2 text-sm focus:border-purple-500 focus:outline-none resize-none">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                    </div>
